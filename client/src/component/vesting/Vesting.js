...
export default function Vesting() {
  ...
  //const [COFFATOToken, setCOFFATOTokenInstance] = useState(null);
  let selectedAccount;
  ...
  const Invest_90 = async() => {
    if(tokenInstance && accounts.length > 0){
        ...
        if(Amount_90 >= 254000000) {
          const _amount = Number(Amount_90 * 10 ** 9);
    ...
    if(tokenInstance && accounts.length > 0){
      ...
      if (isVested_temp) {
        ...
        if(Amount_180 >= 254000000) {
          const _amount = Number(Amount_180 * 10**9);
          var amount = _amount.toLocaleString('fullwide', {useGrouping:false});
    ...
    if(tokenInstance && accounts.length > 0){
      ...
      if (isVested_temp) {
        ...
        if(Amount_270 >= 254000000) {
          const _amount = Number(Amount_270 * 10**9);
          var amount = _amount.toLocaleString('fullwide', {useGrouping:false});
    ...
    if(tokenInstance && accounts.length > 0){
      ...
      if (isVested_temp) {
        ...
        if(Amount_360 >= 254000000) {
          const _amount = Number(Amount_360 * 10**9);
          var amount = _amount.toLocaleString('fullwide', {useGrouping:false});
          ...
          <nav id="navigation1" className="navigation">
            ...
            <div className="nav-menus-wrapper xs-menu">
              <ul className="nav-menu align-to-right">
                <li>
                    <button className="wallet_connect_btn" onClick={() => { onConnect() }}>
                        Connect Wallet
                    </button>
                </li>
              </ul>
          ...
          <div className="container">
            ...
            <div className="row vesting-section1">
              <div className=" col-lg-4 offset-lg-1 col-md-6 align-self-center" >
                ...
                <img className=""    src="assets/images/banner.png"/>
                
              </div>
              <div className="content col-lg-5 offset-lg-1 col-md-6 align-self-center wow fadeInUp" data-wow-duration="2s">
                <div className='content-head'>Welcome to DOOD Staking Portal</div>
                <div className='content_body'><i>DOOD Token is a utility token for the DoodCats and will be used on future projects.</i></div>
                <div className='content_body'><i>Stake your DoodCats and earn 100 $DOOD Token everyday</i></div>
              ...
              <div className="col-lg-4 offset-lg-1 col-md-6 wow fadeInUp mt-5" data-wow-duration="1.5s">
                <div className="xs-count-down">
                  <div className="btn-wrapper text-center">
                    ...
                    {!isVested_90 && (<button className="btn btn-primary" onClick={() => Invest_90()}>STAKING</button>)}
                    {isVested_90 && (<button className="btn btn-primary" onClick={() => claim()}>CLAIM</button>)}
                  </div>
                </div>
              </div>
              <div className="col-lg-4 offset-lg-2 col-md-6 wow fadeInUp mt-5" data-wow-duration="2s">
                <div className="xs-count-down">
                  <div className="btn-wrapper text-center">
                    ...
                    {!isVested_180 && (<button className="btn btn-primary" onClick={() => Invest_180()}>STAKING</button>)}
                    {isVested_180 && (<button className="btn btn-primary" onClick={() => claim()}>CLAIM</button>)}
                  </div>
                </div>
              </div>
              <div className="col-lg-4 offset-lg-1 col-md-6 wow fadeInUp mt-5" data-wow-duration="2.5s">
                <div className="xs-count-down">
                  <div className="btn-wrapper text-center">
                    ...
                    {!isVested_270 && (<button className="btn btn-primary" onClick={() => Invest_270()}>STAKING</button>)}
                    {isVested_270 && (<button className="btn btn-primary" onClick={() => claim()}>CLAIM</button>)}
                  </div>
                </div>
              </div>
              <div className="col-lg-4 offset-lg-2 col-md-6 wow fadeInUp mt-5" data-wow-duration="3s">
                <div className="xs-count-down">
                  <div className="btn-wrapper text-center">
                    ...
                    {!isVested_360 && (<button className="btn btn-primary" onClick={() => Invest_360()}>STAKING</button>)}
                    {isVested_360 && (<button className="btn btn-primary" onClick={() => claim()}>CLAIM</button>)}
                  </div>
                </div>
              </div>
            </div>
